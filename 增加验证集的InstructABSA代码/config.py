...
class Config(object):
    ...
    def __init__(self):
        ...
        self.validation_split_size = 0.0
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-eval_strategy', help='no/epoch/steps', default='epoch', type=str)
        ...
        parser.add_argument('-validation_split_size', help='Proportion of training data to use for validation', default=0.0, type=float)
        parser.add_argument('-test_input', help='The input review to test', type=str)
        parser.add_argument('-load_best_model_at_end', help='Load best model at end', default=False, type=bool)
        return parser